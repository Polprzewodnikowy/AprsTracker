...
INC_DIRS = inc afsk aprs gps misc protocol tracker usb usb/hal usb/core usb/class
...
SRCS_DIRS = afsk aprs gps misc protocol tracker usb usb/hal usb/core usb/class
